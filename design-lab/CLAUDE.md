...
│   ├── page.tsx            ← directory landing page — lists both mock-app and standalone prototypes
...
├── lib/
│   ├── folders.ts          ← mock-app project registry — add entries here for new mock-app routes
│   ├── standalone-generated.ts  ← DO NOT EDIT — auto-generated by scripts/sync-standalone.js
│   └── mock/
...
├── scripts/
│   └── sync-standalone.js  ← runs before dev/build; copies standalone-apps/ and generates standalone-generated.ts
└── public/
    ├── duetto-logo.svg
    └── standalone-apps/    ← DO NOT EDIT — auto-generated by sync-standalone.js
```
